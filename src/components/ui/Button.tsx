...
export function buttonClassName(variant: ButtonVariant = "primary", className?: string) {
  return cn(
    ...
    variant === "primary" &&
      "border-[var(--color-accent)] bg-[var(--color-accent)] text-[var(--color-accent-contrast)] shadow-[0_10px_26px_-18px_rgba(176,192,209,0.9)] hover:-translate-y-[1px] hover:border-[var(--color-accent-strong)] hover:bg-[var(--color-accent-strong)]",
    variant === "secondary" &&
