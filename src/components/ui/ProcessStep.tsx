...
export function ProcessStep({ step, title, detail, deliverable }: ProcessStepProps) {
  return (
    <article className="block-reading card-motion card-motion-border fade-up rounded-[var(--radius-md)] reading-block-breathing" data-stagger={step}>
      ...
      <p className="mt-2 text-[0.93rem] leading-relaxed text-[var(--color-text-muted)]">{detail}</p>
